...
/**
 The base class for all OarLokMobile modules
 */
...
/**
 OarLokMobile Platform calls this method on startup.
 */
-(void)startup;

/**
 OarLokMobile Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 OarLokMobile Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 OarLokMobile Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 OarLokMobile Platform calls this method on resume.
 @param sender The sender of the event.
 */
