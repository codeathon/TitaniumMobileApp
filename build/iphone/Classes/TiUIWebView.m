...
static NSString * const kOarLokMobileJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_oarlokmobileInjection
{
	...
	[html appendString:kOarLokMobileJavascript];
...
{
	// attempt to make well-formed HTML and inject in our OarLokMobile bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _oarlokmobileInjection]];
