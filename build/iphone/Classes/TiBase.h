...
// in simulator we redefine to format for OarLokMobile Developer console
...
{\
	NSString * exceptionName = [@"org.oarlokmobile." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.oarlokmobile";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIOarLokMobileNativeItemNone = -1, 
	UIOarLokMobileNativeItemSpinner = -2,
	UIOarLokMobileNativeItemProgressBar = -3,
	
	UIOarLokMobileNativeItemSlider = -4,
	UIOarLokMobileNativeItemSwitch = -5,
	UIOarLokMobileNativeItemMultiButton = -6,
	UIOarLokMobileNativeItemSegmented = -7,
	
	UIOarLokMobileNativeItemTextView = -8,
	UIOarLokMobileNativeItemTextField = -9,
	UIOarLokMobileNativeItemSearchBar = -10,
	
	UIOarLokMobileNativeItemPicker = -11,
	UIOarLokMobileNativeItemDatePicker = -12,
	
	UIOarLokMobileNativeItemInfoLight = -13,
	UIOarLokMobileNativeItemInfoDark = -14,
	
	UIOarLokMobileNativeItemDisclosure = -15,
	
	UIOarLokMobileNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all OarLokMobile instances of
