 ...
 * Copyright (c) 2009-2011 by OarLokMobile, Inc. All Rights Reserved.
...
//@interface OarLokMobileObject : NSObject
//@end

@interface OarLokMobileObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[OarLokMobileObject class]])
		{
			for (NSString *key in [[(OarLokMobileObject*)o modules] allKeys])
			{
