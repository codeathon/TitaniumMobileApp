...
//Rare exceptions to indicate a bug in the _oarlokmobile code (Eg, function that a subclass should have implemented)
...
/**
 The base class for OarLokMobile proxies.
 */
