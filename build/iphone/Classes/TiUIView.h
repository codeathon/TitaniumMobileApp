...
/**
 Base class for all OarLokMobile views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the OarLokMobile view hierarchy (such as wrapped iOS UIViews) was touched.
