...
@interface OarLokMobileObject : KrollCoverageObject {
#else
@interface OarLokMobileObject : KrollObject {
#endif
@private
...
extern NSString * OarLokMobile$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	OarLokMobileObject *_oarlokmobile;
    KrollObject* console;
	BOOL shutdown;
