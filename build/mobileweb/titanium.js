...
var require = {
	app: {
		analytics: true,
		copyright: "2012 by flipteamflip",
		deployType: "development",
		description: "not specified",
		guid: "c436871d-63eb-492c-a7f8-228bc0da68aa",
		id: "rohit.ainapure",
		name: "OarLokMobile",
		names: {},
		publisher: "flipteamflip",
		url: "http://",
		version: "1.0"
	},
	has: {
...
p.setString("acs-api-key-production","2UwIARWd5EpYlpsOEP4nes2QvCpnuveb");
p.setString("acs-api-key-development","6mPUmFpo87Q8Qry45VTPIvGtJWTXT9zB");
p.setString("acs-oauth-secret-development","9P60YLnD2xik3pveFTozT25fvs9IUQBD");
p.setString("ti.map.apikey","");
p.setString("ti.ui.defaultunit","system");
p.setString("acs-oauth-secret-production","AcuP2HxbX9kVABhmEV4Ws76UtW4unEmu");
p.setString("acs-oauth-key-development","Emo8Z8lykfMre99BMJYyiBIHnWbAbDQj");
p.setString("ti.map.backend","Ti/_/Map/Google");
p.setString("ti.fs.backend","Ti/_/Filesystem/Local");
p.setString("acs-oauth-key-production","Eep3Y1SsB7xu72DydWaobtKt2BXz7RER");
});
