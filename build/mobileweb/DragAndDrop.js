...
DragAndDrop.touchHandler(e); }, false );
...
DragAndDrop.touchHandler(e); }, false );
        ...
        touchHandler: function(_event) {
                if(_event.type == "touchstart") {
                        ...
                        Ti.API.info("DragAndDrop: Not a valid touch event");
                }
        },
        withinContainer: function() {
                ...
                if(this.container) {
                        ...
                        if(this.element.left > this.container.left + this.container.width)
{ contained = false; }
                        if(this.element.left + this.element.width > this.container.left +
this.container.width) { contained = false; }
                        if(this.element.top < this.container.top) { contained = false; }
                        if(this.element.top > this.container.top + this.container.height) {
contained = false; }
                        if(this.element.top + this.element.height > this.container.top +
this.container.height) { contained = false; }
                } else {
                        contained = false;
                }
